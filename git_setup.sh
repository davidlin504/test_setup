...
EXPORT_GIT_MAIL_CMD="export GIT_AUTHOR_EMAIL=${GIT_USER}@asus.com"
...
git config --global user.email ${GIT_USER}@gamil.com
...
echo "You can start using Git now, without password prompt."